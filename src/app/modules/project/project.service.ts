...
// // const assertValidObjectId = (id: string, label = "ID") => {
...
// //     projectsQuery.build().populate(populateOptions),
...
// //     // Prevent changing soft-delete fields through normal update
// //     const {
// //         isDeleted,
// //         deletedAt,
// //         deletedBy,
...
// /**
//  * Shift priorities: any project with priority >= newPriority (excluding
//  * the current project, if updating) gets bumped by 1. Processed from
//  * highest priority down to newPriority to avoid unique-index collisions.
//  */
...
//   if (excludeProjectId) {
//     filter._id = { $ne: toObjectId(excludeProjectId) };
//   }

//   const projectsToShift = await Project.find(filter)
//     .sort({ priority: -1 })
//     .select("_id priority");
...
//     await shiftPriorities(payload.priority);
//   }
...
//       await shiftPriorities(payload.priority, projectId);
//     }
//   }
